...
if ($groupByProject)
{
	...
	{
		$rsGroups = CSocNetGroup::GetList(array("ID" => "ASC"), array("ID" => array_unique($arGroupsIDs)), false, false, ['*', 'UF_*']);
		while ($arGroup = $rsGroups->GetNext())
		{
		    $arGroup["SORT"] = ($arGroup['UF_SORT']) ? $arGroup['UF_SORT'] : 500;
    ...
    include $_SERVER['DOCUMENT_ROOT'] . '/local/includes/_components/tasks.list.gantt/result_modifier.php';
}
